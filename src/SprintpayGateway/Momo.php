<?php
   ...
   class Momo {
        ...
        public static function makePaiement($numero,$montant,$description,$nom,$prenom,$email,$produit,$pays,$autorisation,$datetime) {
        ...
        public static function makePaiementTest($numero,$montant,$description,$nom,$prenom,$email,$produit,$pays,$autorisation,$datetime) {
